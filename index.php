...
$views = [
	...
	'gerenciador_arquivos' => __DIR__ . '/views/manager/gerenciadorArquivos.php',
];
	...
	<body class="bg-light">
		<main class="container py-5">
			...
			<div class="list-group">
				...
				<a class="list-group-item list-group-item-action" href="index.php?page=gerenciador_arquivos">Gerenciador de arquivos</a>
			</div>
		</main>
	</body>
	</html>
